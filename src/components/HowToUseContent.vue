          ...
          <div class="content-section">
            ...
            <v-alert type="info" variant="tonal" class="my-4">
              ...
              <ul class="feature-list">
                ...
                <li><strong>Smart Date Formatting</strong> — Convert dates to standard formats</li>
            ...
            <v-timeline density="compact" side="end">
              <v-timeline-item dot-color="primary" size="small">
                <div class="step-content">
                  ...
                  <p>Create a .docx file with placeholders like <code>{Plant Name}</code> reflecting the column names in your spreadsheet</p>
                </div>
              </v-timeline-item>
              <v-timeline-item dot-color="primary" size="small">
                <div class="step-content">
        ...
        <v-expansion-panel-text>
          <div class="content-section">
            <p class="section-text mb-4">
              Ready to test the app? We've prepared a set of showcase files for you to experiment with. 
              <strong>Download them to your computer</strong>, then upload them to the app (at the top of the page) to see the generator in action.
            </p>
            ...
            <div class="d-flex flex-column gap-2 mb-4">
              ...
              >
                <div class="d-flex flex-column align-start">
                  ...
                  <span class="text-caption opacity-80" style="line-height: 1">Contains placeholders for Species, Location, etc.</span>
                </div>
              </v-btn>
              ...
              >
                <div class="d-flex flex-column align-start">
                  <span class="font-weight-bold">Download Data Spreadsheet</span>
                  <span class="text-caption opacity-80" style="line-height: 1">A mock collection dataset</span>
                </div>
              </v-btn>
            </div>
          </div>
        ...
        <v-expansion-panel-text>
          <div class="content-section">
            ...
            <p class="section-text mb-2">
              To understand how templates work, let's look at this expanded dataset. 
              Notice the <strong>"Copies"</strong> column — we can use this to tell the app how many labels to print for each row.
            </p>
            ...
            <ul class="option-list">
              <li><strong>Placeholders:</strong> Use column headers inside curly braces, e.g., <code>{Species}</code>.</li>
              <li><strong>Next Record:</strong> Use <code>{:next}</code> to tell the system to jump to the next row (or next duplicate copy).</li>
            </ul>

            <v-divider class="my-4"></v-divider>

            <h5 class="subsection-heading">3. Standard Example: Multiple Labels per Page</h5>
            <p class="section-text">
              This example demonstrates a <strong>2x2 grid</strong> (4 labels per page). 
            </p>
            <v-alert type="info" variant="tonal" density="compact" class="my-3 border-s-4">
              <template v-slot:prepend>
                <v-icon color="info">mdi-information</v-icon>
              </template>
              <div class="text-body-2">
                <strong>Duplicate Handling:</strong> If you select the "Copies" column in the <em>Label copies</em> settings, the app will generate 2 labels for <em>Acer rubrum</em> before moving to <em>Quercus alba</em>. This is often useful e.g. when you recorded how many duplicates of each specimen you have and want to print sets of labels for each set of duplicated specimens. <br/><br/>In the <em>Label copies</em> settings you can use the <em>offset by</em> option to increase or decrease the given number of copies. A use case is when you want to send all but one duplicate of your specimens to other institutions and print the appropriate (duplicates count minus one for the one you keep) number of labels.
              </div>
            </v-alert>

            <div class="mt-4 mb-1 text-caption font-weight-bold text-uppercase text-grey-darken-1">Word Template Layout (2x2)</div>
            <v-card variant="outlined" class="pa-0 overflow-hidden mb-4">
              <div class="d-flex border-b">
                ...
                <div class="flex-1 pa-3 bg-grey-lighten-5">
                  ...
                  <code class="text-warning font-weight-bold text-caption d-block mb-1">{:next}</code>
                  <div class="font-weight-bold text-primary">{Species}</div>
                  <div class="text-caption mt-1">
                    Loc: {Location}<br>
                    Date: {Date}<br>
            ...
            <div class="mt-2 mb-1 text-caption font-weight-bold text-uppercase text-grey-darken-1">Result (Sheet 1)</div>
            <v-card variant="flat" class="pa-2 border bg-grey-lighten-4 mb-4">
              <div class="d-flex gap-2">
                <v-sheet class="flex-1 pa-2 rounded border border-s-4" style="border-left-color: #2196F3 !important;" elevation="1">
                  ...
                  <div class="mt-1 text-xs text-blue font-weight-bold">Copy 1 of 2</div>
                </v-sheet>
                ...
                <v-sheet class="flex-1 pa-2 rounded border border-s-4" style="border-left-color: #2196F3 !important;" elevation="1">
                  ...
                  <div class="mt-1 text-xs text-blue font-weight-bold">Copy 2 of 2</div>
                </v-sheet>
              </div>
            ...
            <h5 class="subsection-heading">4. Advanced: Paired Labels (Vial + Sheet)</h5>
            <p class="section-text">
              You may need to print two different labels of different formats for the <strong>same specimen</strong> side-by-side. 
            </p>
            ...
            <div class="mt-4 mb-1 text-caption font-weight-bold text-uppercase text-grey-darken-1">Step A: Word Template Layout</div>
            <v-card variant="outlined" class="pa-3 template-example">
              <div class="d-flex gap-2 align-stretch">
                <div class="flex-1 pa-2 border small-label position-relative">
                  <div class="text-caption text-grey mb-1">Cell 1: Vial Label</div>
                  <code>{Species}<br>#{ID_No}</code>
                </div>
                
                <div class="flex-1 pa-2 border detailed-label position-relative">
                  <div class="text-caption text-grey mb-1">Cell 2: Container Label</div>
                  <code><strong>COLLECTION VOUCHER</strong><br>
                  Taxon: {Species}<br>
                  Loc: {Location}<br>
                  Date: {Date}</code>
                </div>
              ...
              <div class="text-center my-2 position-relative">
                <v-divider class="position-absolute w-100" style="top: 50%"></v-divider>
                <span class="bg-white px-2 position-relative text-caption">
                  <code class="text-warning font-weight-bold">{:next}</code> (System jumps to Row 2)
                </span>
              </div>
            ...
            <div class="mt-4 mb-1 text-caption font-weight-bold text-uppercase text-grey-darken-1">Step B: Final Generated Document</div>
            <v-card variant="flat" class="pa-3 border bg-grey-lighten-4">
              <div class="d-flex gap-2 mb-3 bg-white pa-2 elevation-1 rounded">
                <div class="flex-1 pa-2 border-e d-flex flex-column justify-center">
                ...
                <div class="flex-1 pa-2 pl-4">
                  <div class="font-weight-bold text-caption mb-1">COLLECTION VOUCHER</div>
                  <div class="text-caption text-grey-darken-2" style="line-height: 1.3;">
