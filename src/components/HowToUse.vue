<template>
  <!-- This component is now deprecated - use HelpDrawer with HowToUseContent instead -->
  <div class="help-sections-legacy" v-if="false">
    <!-- How to Use Section -->
...
<script setup>
// Legacy component - functionality moved to HelpDrawer and HowToUseContent
import { ref } from 'vue'
